...
Create a new virtual python environment (e.g. python 3.12).
...
- Current board state (MINE, EMPTY, THEIRS)
...
- `games_batch_to_board_state_flipped_played_BLC`: Above mentioned information.
- `games_batch_to_board_state_classifier_input_BLC`: Which squares are MINE, EMPTY, or THEIRS.
- `games_batch_to_input_tokens_flipped_bs_classifier_input_BLC`: Which moves have been played, which squares were flipped by the most recent move.
- Many others.

## Decision trees
- Ground truth regression decision tree
- Ground truth classification decision tree
- Linear probe direction continous regression decision trees
