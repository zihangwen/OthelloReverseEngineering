...
def evaluate_dt(
    ...
    print(f"Evaluating decision trees {train_dataset_size} on test data...")
...
def main():
    ...
    decision_tree_files = [
        "neuron_simulation/decision_trees_bs/decision_trees_mlp_neuron_6000.pkl",
        "neuron_simulation/decision_trees_bs/decision_trees_mlp_neuron_600.pkl",
        "neuron_simulation/decision_trees_bs/decision_trees_mlp_neuron_60.pkl",
    ]
    ...
    output_location = "neuron_simulation/decision_trees_bs_eval"
